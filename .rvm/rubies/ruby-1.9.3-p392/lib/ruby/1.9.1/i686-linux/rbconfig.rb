...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.9.3-p392")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix=/usr/local/rvm/rubies/ruby-1.9.3-p392' '--enable-shared' '--enable-load-relative' '--sysconfdir=/etc'"
